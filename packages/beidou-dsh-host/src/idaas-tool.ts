...
import { createIdaasAuth, type IdaasAuth } from "@beidou/core/src/auth/idaas.ts";
...
export function buildIdaasAuth(opts: { serviceUrl?: string; appId?: string; serviceToken?: string } = {}): IdaasAuth {
  return createIdaasAuth(
    {
      serviceUrl: opts.serviceUrl ?? "https://idaas-auth-service.example.com",
